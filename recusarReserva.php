...
if (isset($_GET['id'])) {
    ...
    $queryAceitar = "UPDATE reservas SET status = 'recusada' WHERE id = ?";
    ...
    if ($stmtAceitar->execute()) {
        ...
        $mensagemNotificacao = "Sua reserva para o dia " . $data . " foi recusada.";
        ...
        header("Location: gerenciaReservas.php?message=Reserva recusada.");
    } else {
        echo "Erro ao recusar a reserva.";
    }
